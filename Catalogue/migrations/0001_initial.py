# Generated by Django 3.1.5 on 2021-04-13 16:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('jewelry_type', models.CharField(blank=True, choices=[('Pendant', 'Pendant'), ('Bracelet', 'Bracelet'), ('Cufflink', 'Cufflink'), ('Earrings', 'Earrings'), ('Necklace', 'Necklace'), ('Ring', 'Ring'), ('Brooche', 'Brooche'), ('Gem', 'Gem'), ('Other', 'Other')], max_length=10, null=True)),
                ('colour', models.CharField(blank=True, max_length=100, null=True)),
                ('material', models.CharField(blank=True, max_length=100, null=True)),
                ('size', models.IntegerField(blank=True, null=True)),
                ('weight', models.IntegerField(blank=True, null=True)),
